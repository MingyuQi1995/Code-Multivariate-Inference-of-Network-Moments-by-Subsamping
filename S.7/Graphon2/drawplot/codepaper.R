...
load("/Users/mingyuqi/Desktop/netsimures/graphon2/b05/simu025/eval.Rdata")
setwd("/Users/mingyuqi/Desktop/netsimures/graphon2/b05/simu025")
...
source("/Users/mingyuqi/Desktop/netsimures/graphon2/b05/simu025/legend.R")

#source("/Users/mingyuqi/Desktop/netsimures/graphon1/b05/simu01/legend.R")
...
p3 <- ggplot(d1, aes(x=g, y= log(Mean), colour=variable, group=variable)) +
  ...
  theme(panel.grid=element_blank(),
        ...
        axis.title.y = element_text(size = bs))+
  scale_x_discrete(expand=expansion(add=0.4))+
  scale_y_continuous(limits = c(-2.6, -0.4),
                     breaks=c(-0.6,-1.2,-1.8,-2.4),
                     #                labels = c("0.14", "0.21", "0.28", "0.35"),
                     expand=expansion(add=0.01)) +
  scale_color_manual(values =  colorManualunit)+
